...
export default function ProductCategories() {
  ...
  return (
    <section className="py-16 bg-[#fcfcf6] mb-20 overflow-hidden">
      <div className="max-w-[1152px] mx-auto px-4">
        {/* Story Section */}
        <div className="max-w-[900px] mx-auto text-center mb-12">
          <div ref={titleRef}>
            <h3
              className={`text-[56px] font-bold text-[#45690b] mb-6 uppercase transition-all duration-700 ${
                titleVisible
          ...
          <div ref={textRef}>
            <p
              className={`text-[30px] text-[#1d4220] leading-relaxed mb-8 transition-all duration-700 delay-200 ${
                textVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            ...
            <button className="bg-[#45690b] text-white px-8 py-3 rounded-full text-[16px] font-bold hover:bg-[#42612e] hover:scale-105 hover:shadow-lg transition-all duration-300 uppercase">
              Tìm hiểu
            </button>
          </div>
        </div>
        ...
        <div ref={imageRef} className="relative max-w-[900px] mx-auto">
          {/* Main center image */}
          <div
            className={`mt-[100px] rounded-2xl overflow-hidden shadow-xl transition-all duration-1000 ${
              imageVisible
